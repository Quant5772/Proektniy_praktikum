const TabMindI18n = (() => {
  const translations = {
    en: {
      ...
      sectionManageCategoriesHint: 'Add or remove tab categories. At least one category is required.',
    ...
    ru: {
      ...
      sectionManageCategoriesHint: 'Добавляйте или удаляйте категории вкладок. Нужна минимум одна категория.',
